...
export class DiagnosisComponent {
  ...
  constructor(
    ...
    this.form = this.fb.group({
      ...
      "diseasediagnoses": new FormControl('',[Validators.required]),
      "disease": new FormControl('',[Validators.required]),
      "symptomdiagnoses": new FormControl('',[Validators.required]),
      "severity": new FormControl('',[Validators.required]),
      "bplevel": new FormControl('',[Validators.required]),
      ...
      "allergydiagnoses": new FormControl('',[Validators.required]),
